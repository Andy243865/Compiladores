...
_lr_productions = [
  ...
  ('if_statement -> IF LPAREN condition RPAREN THEN LBRACE statements RBRACE ELSE LBRACE statements RBRACE FI','if_statement',13,'p_if_statement','compilador.py',183),
  ('if_statement -> IF LPAREN condition RPAREN THEN LBRACE statements RBRACE FI','if_statement',9,'p_if_statement','compilador.py',184),
  ('write_statement -> WRITE expression SEMICOLON','write_statement',3,'p_write_statement','compilador.py',191),
  ('do_statement -> DO LBRACE statements RBRACE UNTIL LPAREN condition RPAREN SEMICOLON','do_statement',9,'p_do_statement','compilador.py',195),
  ('while_statement -> WHILE LPAREN condition RPAREN LBRACE statements RBRACE','while_statement',7,'p_while_statement','compilador.py',199),
  ('expression -> expression PLUS term','expression',3,'p_expression','compilador.py',203),
  ('expression -> expression MINUS term','expression',3,'p_expression','compilador.py',204),
  ('expression -> term','expression',1,'p_expression','compilador.py',205),
  ('term -> term TIMES factor','term',3,'p_term','compilador.py',212),
  ('term -> term DIVIDE factor','term',3,'p_term','compilador.py',213),
  ('term -> factor','term',1,'p_term','compilador.py',214),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','compilador.py',221),
  ('factor -> NUMBER','factor',1,'p_factor','compilador.py',222),
  ('factor -> FLOAT_NUMBER','factor',1,'p_factor','compilador.py',223),
  ('factor -> IDENTIFIER','factor',1,'p_factor','compilador.py',224),
  ('condition -> expression EQUALS expression','condition',3,'p_condition','compilador.py',231),
  ('condition -> expression NOTEQUALS expression','condition',3,'p_condition','compilador.py',232),
  ('condition -> expression LESS expression','condition',3,'p_condition','compilador.py',233),
  ('condition -> expression LESSEQUAL expression','condition',3,'p_condition','compilador.py',234),
  ('condition -> expression GREATER expression','condition',3,'p_condition','compilador.py',235),
  ('condition -> expression GREATEREQUAL expression','condition',3,'p_condition','compilador.py',236),
  ('condition -> expression AND expression','condition',3,'p_condition','compilador.py',237),
  ('condition -> expression OR expression','condition',3,'p_condition','compilador.py',238),
  ('empty -> <empty>','empty',0,'p_empty','compilador.py',242),
]
